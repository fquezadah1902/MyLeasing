    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                ModelState.AddModelError(string.Empty, "User with this mail already exits.");
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "Owner can't be to delete because it has properties.");
        ...
        public async Task<IActionResult> DeleteProperty(int? id)
        {
            ...
            {
                ModelState.AddModelError(String.Empty, "Then Property can't be delete because it has contracts.");
